...
@section('content')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
        <div class="offcanvas-header border-bottom">
            <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Tambah Pelanggan</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
            <form id="addNewUserForm" novalidate>
                <div class="mb-6 form-control-validation fv-plugins-icon-container">
                    <label class="form-label" for="add-user-fullname">Nama Instansi</label>
                    <input type="text" class="form-control" id="add-user-fullname" name="full_name"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditUser" aria-labelledby="offcanvasEditUserLabel">
        <div class="offcanvas-header border-bottom">
            <h5 id="offcanvasEditUserLabel" class="offcanvas-title">Edit Pelanggan</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
            <form id="editUserForm" novalidate>
                ...
                <div class="mb-6 form-control-validation fv-plugins-icon-container">
                    <label class="form-label" for="edit-user-fullname">Nama Instansi</label>
                    <input type="text" class="form-control" id="edit-user-fullname" name="full_name"
                        placeholder="John Doe" required>
                    <div class="invalid-feedback"></div>
                </div>
                <div class="mb-6 form-control-validation fv-plugins-icon-container">
...
@push('scripts')
    ...
    <script>
        ...
        addNewUserForm.addEventListener('submit', function(e) {
            ...
            axios.post('/superadmin/customers', formData)
                .then(() => {
