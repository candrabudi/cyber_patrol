            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card card-border-shadow-warning h-100">
                    <div class="card-body">
                        ...
                        <p class="mb-0">
                            <span class="text-heading fw-medium me-2 {{ $pendingGrowth >= 0 ? 'text-success' : 'text-danger' }}">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card card-border-shadow-success h-100">
                    <div class="card-body">
                        ...
                        <p class="mb-0">
                            <span class="text-heading fw-medium me-2 {{ $approvedGrowth >= 0 ? 'text-success' : 'text-danger' }}">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card card-border-shadow-danger h-100">
                    <div class="card-body">
                        ...
                        <p class="mb-0">
                            <span class="text-heading fw-medium me-2 {{ $rejectedGrowth >= 0 ? 'text-success' : 'text-danger' }}">
